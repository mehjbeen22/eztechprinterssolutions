const PrinterSetup = () => {
  return (
    <main className="bg-gray-100 min-h-screen flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
      <h2 className="text-4xl mb-8 text-[#115e59] font-semibold">
        Printer Setup Issue
      </h2>
            ...
            >
              <div className="sm:w-1/2">
                <img
                  src={imageUrl}
                  alt={`Step ${step}`}
                  className="w-full h-64 sm:h-80 rounded-md shadow-md object-cover transition-transform transform hover:scale-105"
                />
              </div>
              <div className="sm:w-1/2 sm:pl-8 mt-4 sm:mt-0">
                <h2 className="text-lg font-semibold text-[#115e59] mb-2">
                  Step - {step}
                </h2>
